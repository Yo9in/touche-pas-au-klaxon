...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($title ?? 'Modifier le trajet') ?></title>
    <link rel="stylesheet"
...
<form method="post" action="/trajets/update" class="row g-3 col-md-6">

    <input type="hidden" name="id_trajet" value="<?= htmlspecialchars($old['id_trajet'] ?? '') ?>">
